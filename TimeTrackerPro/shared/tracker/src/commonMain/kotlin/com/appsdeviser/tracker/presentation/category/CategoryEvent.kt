...
sealed class CategoryEvent {
    ...
    data class RemoveCategoryRequested(val categoryItem: CategoryItem) : CategoryEvent()
    data class RemoveCategoryCanceled(val isFavouriteCategory: Boolean) : CategoryEvent()
