Pod::Spec.new do |spec|
    spec.name                     = 'core'
    spec.version                  = '1.0'
    spec.homepage                 = 'Link to the Shared:Core Module homepage'
    spec.source                   = { :http=> ''}
    spec.authors                  = ''
    spec.license                  = ''
    spec.summary                  = 'Some description for the Shared:Core Module'
    ...
    if !Dir.exist?('build/cocoapods/framework/core.framework') || Dir.empty?('build/cocoapods/framework/core.framework')
        ...
        'pod install' should be executed after running ':generateDummyFramework' Gradle task:
            ...
            ./gradlew :shared:core:generateDummyFramework
